/* =========================================================
   Migración: Módulo de Reportes/Informes Médicos
   Fecha: 15-05-2026
...
CREATE TABLE IF NOT EXISTS medical_reports (
  ...
  professional_id BIGINT NOT NULL,
  consultation_id BIGINT NULL, -- Relación opcional con consulta
  
  -- Contenido
  title VARCHAR(255) NOT NULL,
  body LONGTEXT NOT NULL, -- HTML/Markdown con contenido del informe
  metadata JSON NULL, -- Datos adicionales específicos del tipo de informe
  
  -- Estado del reporte
  status VARCHAR(30) NOT NULL DEFAULT 'draft', -- draft|signed|archived
  ...
  -- PDF generado
  pdf_url TEXT NULL, -- Path del PDF inmutable
  pdf_hash CHAR(64) NULL, -- SHA256 del PDF para integridad
  ...
  KEY idx_report_signed (signed_at),
